...
<nav id="navbar"
	...
	<div class="container-fluid">
		<a href="bank.jsp"><img class="ml-5" alt="logo"
...
<!-- 				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="tours.jsp">Tours</a></li>
		...
		<div class="offcanvas offcanvas-end" tabindex="-1"
			...
			<div class="offcanvas-body">
				<div class="list-group">
					<a href="bank_profile.jsp"
						class="list-group-item list-group-item-action">Bank Profile</a> <a
						href="emergency.jsp" class="list-group-item list-group-item-action">Emergency</a>
