...
<body>
	...
	<main class="main container-fluid">
		...
		<div>
			<%
			if (session.getAttribute("userSignupErrorMsg") != null) {
			%>
			<div class="form-container h-auto bg-danger" style="color: white;">
				<div align="center">
					<span class="bi bi-x-circle-fill"> User
						Already Exist</span>
				</div>
			</div>
			<%
		...
		<div>
			<%
			if (session.getAttribute("userSignupSuccessMsg") != null) {
			%>
		...
		<div class="form-container">
			...
			<form action="signup" class="form" id="signupForm" method="post">
				<input type="text" class="input" name="fname" id="firstName"
					placeholder="First Name" required="required"> <input
					type="text" class="input" name="lname" id="lastName"
					placeholder="Last Name" required="required"> <input
					type="text" class="input" name="state" id="state"
					placeholder="State" required="required"> <input type="text"
					class="input" name="zipcode" id="zipcode" placeholder="Zip Code"
					required="required"><input type="email" class="input"
					name="email" id="email" placeholder="Email" required="required">
				<input onkeyup="VerifyPassword()" type="password" class="input"
